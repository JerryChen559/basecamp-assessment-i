...
var responseCreator = function(param){
  return  param === "green" ? colorResponse = "Green is okay" : 
          param === "red"   ? colorResponse = "I heart red" : 
...
let greeter = (name, number) => `Hi! I am ${name} and I am ${number} years old`;